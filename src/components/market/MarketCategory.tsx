...
interface MarketCategoryProps {
  type: MarketType;
  regions: MarketRegion[]; // Already filtered/processed regions
  viewMode: "grid" | "list";
  searchQuery?: string;
}

/**
 * Renders market data in either grid or list view based on provided props.
 * All filtering logic is handled by the parent component.
 */
export const MarketCategory = ({
  ...
  return (
    ...
    >
      <MarketView type={type} regions={regions} />
    </div>
  );
};
